...
- [Data_Science_for_Business_Analytics_DABC](https://github.com/xz2623/Data_Science_for_Business_Analytics_DABC): a group project to predict the membership enrollment rate of a music-listening social networking website where I was responsible for 2. Logistic regression models 4. decision trees models 5. Random forest models, and 6. Gradient-boosted decision trees models
